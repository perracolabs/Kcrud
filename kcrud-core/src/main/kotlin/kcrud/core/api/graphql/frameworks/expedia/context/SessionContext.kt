...
package kcrud.core.api.graphql.frameworks.expedia.context

import graphql.schema.DataFetchingEnvironment
import io.ktor.http.*
import kcrud.core.admin.env.security.user.ContextUser
import kcrud.core.admin.env.security.user.UserRole
 ...
 */
@ExpediaAPI
class SessionContext(private val env: DataFetchingEnvironment) {

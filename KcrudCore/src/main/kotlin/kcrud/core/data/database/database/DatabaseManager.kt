...
package kcrud.core.data.database.database

import com.zaxxer.hikari.HikariDataSource
import kcrud.core.admin.env.healthcheck.annotation.HealthCheckAPI
import kcrud.core.admin.env.healthcheck.checks.DatabaseCheck
import kcrud.core.data.database.annotation.DatabaseAPI
...
object DatabaseManager {
    ...
    fun init(schemaSetup: (SchemaBuilder.() -> Unit)? = null) {
